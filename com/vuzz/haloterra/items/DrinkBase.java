...
extends Item {
    ...
    public DrinkBase(int power, int time) {
        super(new Item.Properties().func_221540_a(new Food.Builder().func_221455_b().func_221456_a(0).func_221454_a(5.0f).func_221453_d()).func_200917_a(1).func_200916_a(RayaMod.MOD_GROUP));
        this.power = power;
        this.time = time;
    }
    ...
    public ItemStack func_77654_b(ItemStack stack, World world, LivingEntity entity) {
        entity.func_195064_c(new EffectInstance(Effects.field_76424_c, this.time, this.power));
        stack.func_190918_g(1);
        return stack.func_190926_b() ? new ItemStack((IItemProvider)ModItems.CAN.get()) : stack;
    }
