...
implements Implant {
    ...
    public void func_77663_a(ItemStack stack, World world, Entity entity, int tick, boolean bool) {
        ...
        if (player.func_71024_bL().func_75116_a() > 1 && stack.func_77978_p().func_74760_g("energy") < 19950.0f && this.ticks % 400 == 0) {
            stack.func_77978_p().func_74776_a("energy", stack.func_77978_p().func_74760_g("energy") + 120.0f);
    ...
    public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
        ...
        if (!context.func_195999_j().func_225608_bj_()) {
            ...
            if (!context.func_195999_j().func_184216_O().contains("uniquegen")) {
                ...
                EntityType raya = (EntityType)ModEntityTypes.PLAUNT.get();
                PlauntEntity rayaEntity = (PlauntEntity)raya.func_220331_a((ServerWorld)context.func_195991_k(), stack, context.func_195999_j(), context.func_195999_j().func_233580_cy_(), SpawnReason.DISPENSER, false, false);
                context.func_195999_j().getPersistentData().func_74757_a("hasplaunt", true);
    ...
    public void func_77624_a(ItemStack stack, @Nullable World world, List<ITextComponent> text, ITooltipFlag tooltip) {
        text.add((ITextComponent)new StringTextComponent(new TranslationTextComponent("tooltip.haloterra.name").getString() + "Plau F. Gard\n" + new TranslationTextComponent("tooltip.haloterra.plaunt").getString()));
