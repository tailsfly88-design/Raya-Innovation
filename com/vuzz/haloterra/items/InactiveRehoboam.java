...
public class InactiveRehoboam
extends Item
implements Implant {
    public int ticks = 0;

    public InactiveRehoboam() {
        super(new Item.Properties().func_200916_a(RayaMod.MOD_GROUP).func_200915_b(100000).func_200918_c(100000).setNoRepair().func_208103_a(Rarity.EPIC));
    }
    ...
    public void func_77663_a(ItemStack stack, World world, Entity entity, int tick, boolean bool) {
        ...
        stack.func_77978_p().func_74776_a("max_energy", 99998.0f);
        PlayerEntity player = (PlayerEntity)entity;
        if (player.func_71024_bL().func_75116_a() > 1 && stack.func_77978_p().func_74760_g("energy") < 99950.0f && this.ticks % 100 == 0) {
            stack.func_77978_p().func_74776_a("energy", stack.func_77978_p().func_74760_g("energy") + 1000.0f);
        ...
        stack.func_196085_b(100000 - ((int)stack.func_77978_p().func_74760_g("energy") + 1));
    ...
    public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
        ...
        if (!context.func_195999_j().func_225608_bj_()) {
            ...
            if (!context.func_195999_j().func_184216_O().contains("uniquegen")) {
                ...
                EntityType raya = (EntityType)ModEntityTypes.REHOBOAM.get();
                RehoboamEntity rayaEntity = (RehoboamEntity)raya.func_220331_a((ServerWorld)context.func_195991_k(), stack, context.func_195999_j(), context.func_195999_j().func_233580_cy_(), SpawnReason.DISPENSER, false, false);
                context.func_195999_j().getPersistentData().func_74757_a("hasrehoboam", true);
    ...
    public void func_77624_a(ItemStack stack, @Nullable World world, List<ITextComponent> text, ITooltipFlag tooltip) {
        text.add((ITextComponent)new StringTextComponent(new TranslationTextComponent("tooltip.haloterra.name").getString() + "Rehoboam D. Calhoun"));
