...
implements Implant {
    ...
    public void func_77663_a(ItemStack stack, World world, Entity entity, int tick, boolean bool) {
        ...
        stack.func_77978_p().func_74776_a("max_energy", 19998.0f);
        PlayerEntity player = (PlayerEntity)entity;
        if (player.func_71024_bL().func_75116_a() > 1 && stack.func_77978_p().func_74760_g("energy") < 19950.0f && this.ticks % 400 == 0) {
            stack.func_77978_p().func_74776_a("energy", stack.func_77978_p().func_74760_g("energy") + 70.0f);
        ...
        stack.func_196085_b(20000 - ((int)stack.func_77978_p().func_74760_g("energy") + 1));
    ...
    public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
        ...
        if (context.func_195999_j().func_225608_bj_()) {
            ...
            int anim = nbt.func_74762_e("anim");
            String[] faces = new String[]{"anims.haloterra.default", "anims.haloterra.uwu", "anims.haloterra.error", "anims.haloterra.done", "anims.haloterra.loading", "anims.haloterra.attention", "anims.haloterra.sad", "anims.haloterra.smug", "anims.haloterra.angry", "anims.haloterra.wtf", "anims.haloterra.happy", "anims.haloterra.thinking", "anims.haloterra.sad2", "anims.haloterra.redangry", "anims.haloterra.heart", "anims.haloterra.um2", "anims.haloterra.redhappy", "anims.haloterra.silly"};
            if (++anim >= faces.length) {
                anim = 0;
            }
            nbt.func_74768_a("anim", anim);
            context.func_195999_j().func_146105_b((ITextComponent)new StringTextComponent(new TranslationTextComponent("anims.haloterra.anim").getString() + new TranslationTextComponent(faces[anim]).getString()), true);
        } else {
            if (!stack.func_77942_o()) {
                stack.func_77982_d(new CompoundNBT());
            }
            if (!context.func_195999_j().func_184216_O().contains("uniquegen")) {
                ...
                EntityType raya = (EntityType)ModEntityTypes.RAYA_PRIME.get();
                RayaPrimeEntity rayaEntity = (RayaPrimeEntity)raya.func_220331_a((ServerWorld)context.func_195991_k(), stack, context.func_195999_j(), context.func_195999_j().func_233580_cy_(), SpawnReason.DISPENSER, false, false);
                context.func_195999_j().getPersistentData().func_74757_a("hasraya", true);
                ...
                rayaEntity.getPersistentData().func_74768_a("anim", stack.func_77978_p().func_74762_e("anim"));
    ...
    public void func_77624_a(ItemStack stack, @Nullable World world, List<ITextComponent> text, ITooltipFlag tooltip) {
        text.add((ITextComponent)new StringTextComponent(new TranslationTextComponent("tooltip.haloterra.name").getString() + "Raya D. Aber\n" + new TranslationTextComponent("tooltip.haloterra.rayaprime").getString()));
