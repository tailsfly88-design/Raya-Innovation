...
implements IFlyingAnimal {
    ...
    public void func_70071_h_() {
        ...
        if (this.getOwnerUUID() instanceof UUID) {
            this.updateData(this.curEnergy, this.ownerUuid);
        }
        if (this.owner == null) {
            return;
        }
        ...
        if (nbt.func_74767_n("canUseEnergy") && this.getEnergy() <= 0.0f) {
            this.returnAsImplant();
        }
        this.setEnergy(nbt.func_74760_g("energy"));
        this.updateData(this.curEnergy, this.ownerUuid);
        ...
        } else if (distanceBetween > 60.0) {
            this.func_70107_b(this.owner.func_226277_ct_(), this.owner.func_226278_cu_(), this.owner.func_226281_cx_());
        } else {
            this.func_213293_j(this.func_226277_ct_(), this.clamp(this.func_70902_q().func_226280_cw_() - this.func_226278_cu_(), -0.2, 0.2), this.func_226281_cx_());
    ...
    private void updateData(float energy, UUID ownerUuid) {
        ...
        this.setOwner((LivingEntity)this.field_70170_p.func_217371_b(ownerUuid));
    ...
    public boolean func_70097_a(DamageSource damageSource, float damage) {
        if (damageSource != DamageSource.field_76380_i) {
            CompoundNBT nbt = this.getPersistentData();
            this.setEnergy(nbt.func_74760_g("energy"));
            if (this.getEnergy() > damage * 2.0f) {
                nbt.func_74776_a("energy", this.getEnergy() - damage * 2.0f);
                return false;
            }
        }
        return true;
